...
// function combineString(text: string ,number:number):string {
//     return text + number;
// }
...
//     return num1 % num2
// }
// console.log(remainder(11,2))//output 1
//Question 66: Logical AND Verification: Create a function that checks two boolean (true or false) values.
// It should only say true if both are true, using the && operator. For instance, checkBothTrue(true, false) should
// be false.
// function booleanCheck(num3:boolean,num4:boolean):boolean{
//     return num3 && num4;
// }
// console.log(booleanCheck(true,false))//false
// console.log(booleanCheck(true,true))//true
// console.log(booleanCheck(false,false))//true
// console.log(booleanCheck(false,true))//false
