...
// // Alishba ; 2024
// // this massage print a personal message.

let myName1 = "Alishba";
console.log("Hello " +(myName1)+ " Would you like to learn some typescript today?");
...
let myFriends = [ "Aiman", "fiza","Rimsha","nisha"];
...
let myFriendsGroup = ['misbah',"tayyaba","mona"];
console.log("hello " +(myFriendsGroup)+ " Would you like to learn some javascrpt?");
