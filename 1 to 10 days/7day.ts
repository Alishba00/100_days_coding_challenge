...
let dinnerGuest: string[] = ["mano", "muzaammil","misbah","aiman"];
...
let fruits:string[] = ['Mango',"Grapes","Peaches","Stawberry","Gauava"];
...
let car : {
     model: string; company: string; year: Number;color: string;
    } = {
       model: "e-tron",
       company: "Audi",
       year:2022,
...
console.log(
    `The ${car.company} ${car.model}, introduced in ${car.year} , manufactured by ${car.company} , and available in ${car.color} color."`
    );
